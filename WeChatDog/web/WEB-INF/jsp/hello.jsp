...
昵称:<h3>${weiXinUser.nickname}</h3>
性别：<h3>${weiXinUser.sex}</h3>
国家：<h3>${weiXinUser.country}</h3>
省份：<h3>${weiXinUser.province}</h3>
城市：<h3>${weiXinUser.city}</h3>
关注时间：<h3>${weiXinUser.subscribeTime}</h3>
</body>
